	...
	header("location: /userhome.php");
{
	...
	$maxPrezzo = (int)($_REQUEST['maxPrezzo']);
	if(($titolo=="" and $isbn=="") or $maxPrezzo=="")
	{
	...
	else
	{
		...
		$query = \Fr\LS::$dbh->prepare("INSERT INTO richiesto VALUES (NULL, '".\Fr\LS::getUser('id')."', '".\Fr\LS::$dbh->lastInsertId()."', '".$statoConservazione."', '".$maxPrezzo."', '0');");
		$query->execute();
